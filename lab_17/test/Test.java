...
public class Test extends Stack<Integer> {
	...
	public static void main(String[] args) {
		...
		List<String> actualHistory = new ArrayList<String>();
		...
		List<String> expectedHistory = Arrays.asList(
				...
				"from.pop()", "help.push(1)", "from.pop()", "to.push(2)", "help.pop()", "to.push(1)", "from.pop()", "help.push(3)", "to.pop()", "from.push(1)", "to.pop()", "help.push(2)", "from.pop()", "help.push(1)",
				// переносим '4' с 'from' -> на 'to'
				"from.pop()", "to.push(4)",
				// переносим '1'+'2'+'3' с 'help' -> на 'to'
				"help.pop()", "to.push(1)", "help.pop()", "from.push(2)", "to.pop()", "from.push(1)", "help.pop()", "to.push(3)", "from.pop()", "help.push(1)", "from.pop()", "to.push(2)", "help.pop()", "to.push(1)");
